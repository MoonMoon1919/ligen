...
func gettingStarted() doyoucompute.Section {
	...
	getFamiliar.WriteParagraph().
		...
		Link("own documentation", "https://github.com/MoonMoon1919/ligen/tree/main/docs").
	...
	choseATask.WriteParagraph().
		Text("Browse the ").
		Link("issue tracker", "https://github.com/MoonMoon1919/ligen/issues").
...
func codeContributions() doyoucompute.Section {
	...
	setupSection.WriteParagraph().
		...
		Link("https://github.com/MoonMoon1919/ligen", "https://github.com/MoonMoon1919/ligen").
		Text(" by clicking the \"Fork\" button.")

	setupSection.WriteParagraph().
		Text("Then clone your forked repository to your local machine:")

	setupSection.WriteCodeBlock("bash", []string{"git clone <your_fork_url> ligen"}, doyoucompute.Static)
	setupSection.WriteCodeBlock("bash", []string{"cd ligen"}, doyoucompute.Static)
